...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="courseAction_add.action">
			...
			<tr class="user">
        		...
        		<table>
                    ...
                    <tr>
                        ...
                        <td>
                        	<input name="kksj" type="text" class="tcal inptxt" readonly="readonly"/>
						</td>
                    </tr>
                    <tr>
                    	<td class="one">学时</td>
                        <td class="two"><s:textfield name="classHour" cssClass="inptxt" value=""></s:textfield>
						</td>
                     ...
                     <tr>
                    	<td class="one">学分</td>
                        <td class="two"><s:textfield name="credit" cssClass="inptxt" value=""></s:textfield>
						</td>
                    </tr>
                <tr>
                	<td colspan="3"></td>
