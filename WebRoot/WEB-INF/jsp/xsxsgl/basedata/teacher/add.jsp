...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/images/title_arrow.gif"/> 教师信息
        </div>
...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="teacherAction_add.action">
        <div class="ItemBlock_Title1"><!-- 信息说明 --><div class="ItemBlock_Title1">
        	<img border="0" width="4" height="7" src="${pageContext.request.contextPath}/css/blue/images/item_point.gif" /> 教师信息 </div> 
        </div>
        <table id="userwrap">
			<tr class="user">
      		  <td class="right">
        		<table>
            		<tr>
                    	<td class="one">教师号</td>
                        <td class="two"><s:textfield name="jsbh" cssClass="inptxt"></s:textfield>
                        <td class="one">密码</td>
                    ...
                    <tr>
                     ...
                     <tr>
                     	<td class="one">年龄</td>
                    	<td>
                    	<s:textfield name="age" cssClass="inptxt" value=""></s:textfield>
                    	</td>
                    	<td class="one">教师职称</td>
                    	<td>
                    		<s:textfield name="jszc" cssClass="inptxt"></s:textfield>
                    	</td>
                    </tr>
                    <tr>
