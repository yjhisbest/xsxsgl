...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="studentAction_add.action">
			...
			<tr class="user">
        		...
        		<table>
                    ...
                    <tr>
                    	...
                    	<td class="one">性别</td>
                        <td class="two">
                        	<s:radio list="#{'1':'男','2':'女','3':'不详'}" name="sex" value="1"></s:radio>
						</td>
                    </tr>
                     <tr>
                     	<td class="one">出生日期</td>
                    	<td>
                    	<input name="csrq" type="text" class="tcal inptxt" readonly="readonly"/>
                    	</td>
                    	<td class="one">入学日期</td>
                    	<td>
                    		<input name="rxrq" type="text" class="tcal inptxt"/>
                    	</td>
                    </tr>
                    <tr>
                    	...
                    	<td class="one">状态</td>
                        <td width="200px"><s:radio list="#{'1':'在读','2':'毕业','3':'停学','4':'退学'}" name="statue" value="1"></s:radio>
						</td>
                    	
                    </tr>
                     <tr>
                    	<td class="one">政治面貌</td>
                        <td class="two"><s:textfield name="zzmm" cssClass="inptxt" value=""></s:textfield>
						</td>
						<td class="one">生源所在地</td>
                        <td class="two"><s:textfield name="syszd" cssClass="inptxt" value=""></s:textfield>
						</td>
                    </tr>
                <tr>
                	<td colspan="3"></td>
