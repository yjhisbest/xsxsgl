...
<script type="text/javascript">
	$(document).ready(function(){
		...
		myUtils.business.dealList.zhuGXTRClick({
			url:"classTeacherJsonAction_releaseAllTeacher.action",
			mainId:"bjbh"
		});
		myUtils.business.dealList.zhiGXTRClick({
			url:"classTeacherJsonAction_releaseOneTeacher.action",
			mainId:"query_zhi.jsbh"
		});
	});
</script>
</head>
<body>
<table>
	<s:form action="classTeacherAction_showCTGX.action">
	<tr>
    	<td>
            ...
            <table cellspacing="0" cellpadding="0"  id="maintain-right"  style="font-size:12px;text-align: center;" width="950">
               ...
               <!-- 
                ...
                <!-- 
                 ...
                 -->
                <tr class="other">
                   <td style="border-collapse:collapse;  empty-cells:show;"><s:property value="jsbh"/></td>
