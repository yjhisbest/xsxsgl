...
<script type="text/javascript">
	$(document).ready(function(){
		$("body").data("topurl","classStudentJsonAction_getClazz.action");//获取班级
		$("body").data("url","classStudentJsonAction_getStudent.action");//获取专业
		$("body").data("main","query_zhi.xuehao");//url的参数
		$("body").data("tipName","学号");//url的参数
...
<body>
<s:form action="classStudentAction_saveRelation.action">
<table>
	<tr>
    	<td>
    	...
    	<td>
        	<table cellspacing="0" cellpadding="0" id="maintain-top" align="center"  width="800" style="height:40px;" size="size">
                ...
                <tr align="center" id="base">
                 <td style="border-collapse:collapse;  empty-cells:show;" item="xuehao" size="size"><input type="text" style="width:100%;" name="students[0].xuehao"/></td>
                 <td style="border-collapse:collapse;  empty-cells:show;" item="name"><input readonly="readonly" type="text" style="width:100%;" name="students[0].name" id="mainid"/></td>
                 <td style="border-collapse:collapse;  empty-cells:show;" item="cellphone"><input readonly="readonly" type="text" style="width:100%;" name="students[0].cellphone" id="mainid"/></td>
                 <td style="border-collapse:collapse;  empty-cells:show;" item="zzmm"><input readonly="readonly" type="text" style="width:100%;" name="students[0].zzmm" id="mainid"/></td>
                </tr>
             </table>
         </td>
     </tr>
