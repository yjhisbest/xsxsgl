...
<script type="text/javascript">
	$(document).ready(function(){
		...
		myUtils.business.dealList.zhubTRClick({hiddenZhubid:"query_zhi.bjbh"});
		myUtils.business.dealList.checkzhuid({hiddenZhubid:"query_zhi.bjbh"});
		myUtils.business.dealList.zhuGXTRClick({
			url:"classStudentJsonAction_releaseAllStudent.action",
			mainId:"bjbh"
		});
		myUtils.business.dealList.zhiGXTRClick({
			url:"classStudentJsonAction_releaseOneStudent.action",
			mainId:"query_zhi.xuehao"
		});
	});
</script>
</head>
<body>
<table>
	<s:form action="classStudentAction_showCSGX.action">
	<tr>
    	<td>
    	...
    	<td >
            ...
            <table cellspacing="0" cellpadding="0"  id="maintain-right"  style="font-size:12px;text-align: center;" width="950">
               ...
               <!-- 
                ...
                -->
                <s:hidden name="query_zhi.bjbh"></s:hidden>
                ...
                <tr class="other">
                   ...
                   <td style="border-collapse:collapse;  empty-cells:show;"><s:property value="cellphone"/></td>
