...
<script type="text/javascript">
	$(document).ready(function(){
		...
		myUtils.business.dealList.zhubTRClick({hiddenZhubid:"query_zhi.jsbh"});
		myUtils.business.dealList.checkzhuid({hiddenZhubid:"query_zhi.jsbh"});
		myUtils.business.dealList.zhuGXTRClick({
			url:"teacherCourseJsonAction_releaseAllCourse.action",
			mainId:"jsbh"
		});
		myUtils.business.dealList.zhiGXTRClick({
			url:"teacherCourseJsonAction_releaseOneCourse.action",
...
<body>
<table>
	<s:form action="teacherCourseAction_showTCSGX.action">
	<tr>
    	<td>
            ...
            <table class="content" style="font-size:12px;">
            	<tr>
                 <td class="one" style="width:66px;">教师编号</td>
                    <td class="inp">
                    <s:textfield name="query_zhu.jsbh" id="jsbh"></s:textfield>
                    </td>
                    <td class="one" style="width:66px;">教师名称</td>
                    <td class="inp">
                    <s:textfield name="query_zhu.jsmc" id="jsmc"></s:textfield>
                    </td>
                   </tr>
                   <tr>
                	<td class="one" style="width:66px;">教师职称</td>
                    <td class="inp">
                    <s:textfield name="query_zhu.jszc" id="jszc"></s:textfield>
                    </td>
	...
	<tr>
    	<td >
            <div   style=" height:230px; width:1000px;">
            <table cellspacing="0" cellpadding="0" id="maintain-top" align="center"  width="950"  style="font-size:12px;text-align: center;">
                ...
                <s:iterator value="#pageResult_zhub.rows" status="st">
                	<!-- 
                		field属性是用来确认是主表的tr
                	 -->
	                <tr field="item_zhub" id="${jsbh}">
	                   <td style="border-collapse:collapse;  empty-cells:show;cursor: pointer;"><s:property value="jsbh"/></td>
	                   <td style="border-collapse:collapse;  empty-cells:show;"><s:property value="jsmc"/></td>
	                   <td style="border-collapse:collapse;  empty-cells:show;"><s:property value="jszc"/></td>
    	...
    	<td >
            ...
            <table cellspacing="0" cellpadding="0"  id="maintain-right"  style="font-size:12px;text-align: center;" width="950">
                <tr class="two" align="center">
                    ...
                    <td width="150">开课时间</td>
                    <td width="150">考核方式</td>
                    <td width="150">学分</td>
                    <td width="150">操作</td>
                </tr>               
               <!-- 
               		创建一个隐藏域,保存点击的主表的mid
                -->
                <s:hidden name="query_zhi.jsbh"></s:hidden>
                ...
                <tr class="other">
                   ...
                   <td style="border-collapse:collapse;  empty-cells:show;"><s:property value="kksj"/></td>
                   <td style="border-collapse:collapse;  empty-cells:show;"><s:property value="kaohe"/></td>
                   <td style="border-collapse:collapse;  empty-cells:show;"><s:property value="credit"/></td>
